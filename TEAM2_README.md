...
To run the system in reality, you have to modify the [launch file] (../blob/master2/svea_starter/src/svea_core/launch/floor2.launch) in the car. Set is_sim to False and comment line 16 (the one related to map_server). Add the following lines to your launch file:
